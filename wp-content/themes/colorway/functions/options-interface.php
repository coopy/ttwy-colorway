    ...
    foreach ($options as $value) {
        ...
        switch ($value['type']) {
            ...
            case "heading":
                ...
                $menu .= '<li class="nav-tab-list"><a id="' . esc_attr($jquery_click_hook) . '-tab" class="nav-tab" title="' . esc_attr($value['name']) . '" href="' . esc_attr('#' . $jquery_click_hook) . '">' . esc_html($value['name']) . '</a></li>';
