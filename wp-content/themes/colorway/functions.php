...
function inkthemes_wp_enqueue_scripts() {
    if (!is_admin()) {
        ...
        wp_enqueue_script('inkthemes_validate', get_template_directory_uri() . '/js/jquery.validate.js', array('jquery'));
...
function inkthemes_custom_jquery(){
    wp_enqueue_script('inkthemes-mobile-menu', get_template_directory_uri() . "/js/mobile-menu.js", array('jquery'));
}
